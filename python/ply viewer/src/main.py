...
#read in point cloud
    cloud1 = o3d.io.read_point_cloud("output.ply")
    cloud2 = o3d.io.read_point_cloud("LFoot.ply")
    cloud3 = o3d.io.read_point_cloud("LShin.ply")
    cloud4 = o3d.io.read_point_cloud("RFoot.ply")
    cloud5 = o3d.io.read_point_cloud("RShin.ply")

    cloud1.paint_uniform_color([1, 0, 0])  # red
    cloud2.paint_uniform_color([0, 1, 0])  # green
    cloud3.paint_uniform_color([0, 0, 1])  # blue
    cloud4.paint_uniform_color([0, 1, 0])  # green
    cloud5.paint_uniform_color([0, 0, 1])  # blue
